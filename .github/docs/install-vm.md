<div align="center">
  ...
  # Installing tuinix in a Virtual Machine
</div>
...
> <img src="../assets/LOGO.png" width="20"> **Important:** Legacy BIOS (SeaBIOS) will **not** work. tuinix uses GPT partitioning with an EFI System Partition that requires UEFI firmware. ZFS kernel modules are unsigned, so **Secure Boot must be disabled**.
...
> <img src="../assets/LOGO.png" width="20"> **Note:** VirtualBox EFI support can be unreliable. QEMU/KVM (option A or B) is strongly recommended.
